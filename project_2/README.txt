...
## Setup
 ...
 3. Check if antlr-3.5.2-complete.jar is working in your environmnet by typing java -jar antlr-3.5.2-complete.jar. If not working you must download it from ANTLR website
 4. type make
 5. The testing result will be shown ont both the screen and the files in the project folder
